...
SELECT_ENEMY_ATTACK = 'select enemy to attack'
SELECT_ENEMY_SPELL = 'select enemy to use spell on'
...
ENEMY_DAMAGED_SPELL = 'enemy damaged by spell'
...
OFF_SPELL = 'offensive spell'
DEF_SPELL = 'defensive spell'
