...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Project_Cacophonum.py"
 
        #Name of program
        self.project_name = "Project Cacophonum"
        ...
        self.license = "copyleft"
 
        #Auhor of program
        self.author_name = "G. Teng, N. Danziger, original engine by J. Armstrong"
        self.author_email = "gteng@albany.edu"
        self.copyright = "Copyright (c) 2015 Armstrong et al"
 
        #Description
        self.project_description = "i like big butts and i cannot lie"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['data', 'resources']
